...
public class HomeController {
    ...
    public String home(Principal principal, Model model) {
        ...
        Drivers obj1 = new Drivers("Иванов Геннадий Петрович", "19.12.1965", 45, "М", "9");
        Drivers obj2 = new Drivers("Васильев Петр Сергеевич", "19.12.1964", 35, "М", "8");
        Drivers obj3 = new Drivers("Харченко Иван Владимирович", "19.12.1982", 27, "М", "7");
        Drivers obj4 = new Drivers("Суворов Александр Иванович", "29.03.1971", 32, "M", "2");
